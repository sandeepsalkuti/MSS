...
const LandingPage = () => {
    ...
    return (
        <div>
            ...
            <Button type ="rounded" onClick={detailsHandler}>UserDetails</Button>
            <Route path="/user-details" component={UserDetails} />
            </div>
            <div style={{width: "300px", minHeight: "100px",marginTop:"10px",marginLeft:"30px",padding: "10px 20px"}}>
            <Button type ="rounded" onClick={activityHandler}>UserActivity</Button>
